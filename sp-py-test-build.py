...
def main():
    ...
    while True:
        ...
        user_input = input("Enter artist and track name (Artist,TrackName), Spotify link, 'cls' to clear screen, '--bulk PlaylistLink PlaylistName' to process a playlist, '--bulk-album AlbumLink' to process an album, or 'quit' to exit (c to cancel): ")
